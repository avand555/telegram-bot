...
# Set to 2 to protect your 16GB disk when extracting massive 7GB ZIP files
global_semaphore = asyncio.Semaphore(2)
routes = web.RouteTableDef()
link_storage = {}
active_tasks = {}

# Auto-Reconnect Engine for Telegram
...
def get_aria2_executable():
    ...
    print("📥 Downloading static aria2c...")
    try:
...
async def download_direct(url, workspace, msg, start_t, custom_name=None, gdrive_id=None):
    ...
    async with ClientSession(timeout=timeout) as sess:
        ...
        if "text/html" in r.headers.get("Content-Type", "") and not gdrive_id: raise ValueError("HTML webpage detected, not a file.")
        ...
        async with global_semaphore:
            ...
            try:
                ...
                if filename.lower().endswith('.zip'):
                    ...
                    # Extract zip, then DELETE IT IMMEDIATELY to prevent 16GB disk crash
